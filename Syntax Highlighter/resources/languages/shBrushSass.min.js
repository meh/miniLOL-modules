...
*/
(function(){function a(){var b=SyntaxHighlighter.regexLib;this.regexList=[{regex:b.multiLineCComments,css:"comments"},{regex:b.singleLineCComments,css:"comments"},{regex:b.doubleQuotedString,css:"string"},{regex:b.singleQuotedString,css:"string"},{regex:/\#[a-fA-F0-9]{3,6}/g,css:"value"},{regex:/\b(-?\d+)(\.\d+)?(px|em|pt|\:|\%|)\b/g,css:"value"},{regex:/\$\w+/g,css:"variable"},{regex:new RegExp(this.getKeywords("!important !default"),"g"),css:"color3"},{regex:new RegExp(this.getKeywords("@import @extend @debug @warn @if @for @while @mixin @include"),
...
"(?!-)(?!:)\\b|\\b()")+":\\b","g"),css:"value"},{regex:new RegExp(this.getKeywords("[mM]onospace [tT]ahoma [vV]erdana [aA]rial [hH]elvetica [sS]ans-serif [sS]erif [cC]ourier mono sans serif"),"g"),css:"color1"}]}typeof require!="undefined"&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["sass","scss"];SyntaxHighlighter.brushes.Sass=a;typeof exports!="undefined"&&(exports.Brush=a)})();
