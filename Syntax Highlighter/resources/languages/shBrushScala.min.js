...
"gm"),css:"keyword"},{regex:RegExp("[_:=><%#@]+","gm"),css:"keyword"}]}typeof require!="undefined"&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["scala"];SyntaxHighlighter.brushes.Scala=a;typeof exports!="undefined"&&(exports.Brush=a)})();
