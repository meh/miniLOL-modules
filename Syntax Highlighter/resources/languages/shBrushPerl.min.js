...
"gmi"),css:"functions"},{regex:new RegExp(this.getKeywords("bless caller continue dbmclose dbmopen die do dump else elsif eval exit for foreach goto if import last local my next no our package redo ref require return sub tie tied unless untie until use wantarray while"),"gm"),css:"keyword"}];this.forHtmlScript(SyntaxHighlighter.regexLib.phpScriptTags)}typeof require!="undefined"&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["perl",
"Perl","pl"];SyntaxHighlighter.brushes.Perl=a;typeof exports!="undefined"&&(exports.Brush=a)})();
