...
"/resources/styles")}Event.observe(document,":go",function(){miniLOL.module.execute("Syntax Highlighter")});Event.observe(window,"resize",this.doWrap);miniLOL.utils.css("body .syntaxhighlighter .line { white-space: pre-wrap !important; }")},loadFile:function(a){if(a&&!this.loaded[a])if(miniLOL.utils.include(this.root+"/resources/languages/shBrush"+a+".min.js")){this.loaded[a]=true;SyntaxHighlighter.vars.discoveredBrushes={};for(var d in SyntaxHighlighter.brushes){var b=SyntaxHighlighter.brushes[d].aliases;
