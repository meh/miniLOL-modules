EJS.Helpers.prototype.date_tag=function(b,c){c instanceof Date||(c=new Date);for(var a=["January","February","March","April","May","June","July","August","September","October","November","December"],d=[],e=[],f=[],h=c.getFullYear(),i=c.getMonth(),j=c.getDate(),g=h-15;g<h+15;g++)d.push({value:g,text:g});for(g=0;g<12;g++)e.push({value:g,text:a[g]});for(a=0;a<31;a++)f.push({value:a+1,text:a+1});d=this.select_tag(b+"[year]",h,d,{id:b+"[year]"});e=this.select_tag(b+"[month]",i,e,{id:b+"[month]"});f=this.select_tag(b+
"[day]",j,f,{id:b+"[day]"});return d+e+f};EJS.Helpers.prototype.form_tag=function(b,c){c=c||{};c.action=b;if(c.multipart==true){c.method="post";c.enctype="multipart/form-data"}return this.start_tag_for("form",c)};EJS.Helpers.prototype.form_tag_end=function(){return this.tag_end("form")};EJS.Helpers.prototype.hidden_field_tag=function(b,c,a){return this.input_field_tag(b,c,"hidden",a)};
EJS.Helpers.prototype.input_field_tag=function(b,c,a,d){d=d||{};d.id=d.id||b;d.value=c||"";d.type=a||"text";d.name=b;return this.single_tag_for("input",d)};EJS.Helpers.prototype.is_current_page=function(b){return window.location.href==b||window.location.pathname==b?true:false};
