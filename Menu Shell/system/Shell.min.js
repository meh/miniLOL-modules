...
" "&&!e){c.parameters.push(a);a=""}else a+=d[b];c.parameters.push(a);return c},context:function(){return{menu:this._menu,commands:this._commands,variables:this._variables}},set:function(a,c){if(!a)throw Error("No name given.");if(c===null)delete this._variables[a];else this._variables[a]=c},menu:function(a){if(!a)throw Error("The menu can't be null.");this._menu=a},tree:function(){}})})();
